  ...
  <br>
    <div class="table-responsive col-lg-8">
        <table class="table table-striped table-sm">
          <thead>
            <tr>
              ...
              <th scope="col">Verifikasi Barang Agen ke Kurir</th>
        ...
        <tr>
          ...
          @endif </td>
          <td>{{ $pengirimanku->verifikasi_agen_ke_kurir ? 'Sudah' : 'Belum' }}
          @if ($pengirimanku->verifikasi_agen_ke_kurir == 0)
              <br> <a href="/dashboard/pengiriman/{{ $pengirimanku->id }}/edit" class="btn btn-success">Verifikasi</a>
          @endif</td>
      ...
      <div class="table-responsive col-lg-8">
        <table class="table table-striped table-sm">
          <thead>
            <tr>
              ...
              <th scope="col">Dibuat</th>
              <th scope="col">Verifikasi Barang Kurir ke Agen</th>
              <th scope="col">Verifikasi Barang Agen ke Agen</th>
              <th scope="col">Verifikasi Barang Agen ke Kurir</th>
        ...
        <tr>
          ...
          @if ($pengirimanku->verifikasi_kurir_ke_agen == 0)
              <br> <a href="/dashboard/pengiriman/{{ $pengirimanku->id }}/edit" class="btn btn-success">Verifikasi</a>
          @endif </td>
          <td>{{ $pengirimanku->verifikasi_agen_ke_agen ? 'Sudah' : 'Belum' }}
          @if ($pengirimanku->verifikasi_agen_ke_agen == 0)
              <br> <a href="/dashboard/pengiriman/{{ $pengirimanku->id }}/edit" class="btn btn-success">Verifikasi</a>
          @endif</td>
          <td>{{ $pengirimanku->verifikasi_agen_ke_kurir ? 'Sudah' : 'Belum' }}
          @if ($pengirimanku->verifikasi_agen_ke_kurir == 0)
